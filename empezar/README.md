...
| --- | ---: | --- | --- |
| **Node.js** · 22 o superior | 8 impl. en 5 clases | alpinejs, htmx, nodejs | [nodejs.org](https://nodejs.org/en/download) [@nodejs-downloads] |
| **Node.js + pnpm** · Node 22 · pnpm 10 | 108 impl. en 79 clases | angular, drizzle, express, fastify, lit, nestjs, prisma, react, solid, svelte, typeorm, vue | [pnpm.io](https://pnpm.io/installation) [@pnpm-installation] |
...
Ocho cadenas, **384 implementaciones**. Ninguna es obligatoria: el ejecutor corre las que encuentre y **declara** las que omitió.
