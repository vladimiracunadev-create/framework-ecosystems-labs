...
| --- | ---: | --- | --- |
| **Node.js** · 22 o superior | 6 impl. en 4 clases | alpinejs, htmx, nodejs | [nodejs.org](https://nodejs.org/en/download) [@nodejs-downloads] |
| **Node.js + pnpm** · Node 22 · pnpm 10 | 102 impl. en 78 clases | angular, drizzle, express, fastify, lit, nestjs, prisma, react, solid, svelte, typeorm, vue | [pnpm.io](https://pnpm.io/installation) [@pnpm-installation] |
...
Ocho cadenas, **376 implementaciones**. Ninguna es obligatoria: el ejecutor corre las que encuentre y **declara** las que omitió.
