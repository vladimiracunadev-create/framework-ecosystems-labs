...
| **Node.js + pnpm** · Node 22 · pnpm 10 | 163 impl. en 92 clases | angular, astro, drizzle, express, fastify, lit, nestjs, nextjs, nuxt, prisma, react, remix, solid, svelte, sveltekit, typeorm, vue | [pnpm.io](https://pnpm.io/installation) [@pnpm-installation] |
...
Ocho cadenas, **443 implementaciones**. Ninguna es obligatoria: el ejecutor corre las que encuentre y **declara** las que omitió.
