...
| **Node.js + pnpm** · Node 22 · pnpm 10 | 134 impl. en 85 clases | angular, drizzle, express, fastify, lit, nestjs, prisma, react, solid, svelte, typeorm, vue | [pnpm.io](https://pnpm.io/installation) [@pnpm-installation] |
...
Ocho cadenas, **412 implementaciones**. Ninguna es obligatoria: el ejecutor corre las que encuentre y **declara** las que omitió.
