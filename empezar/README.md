...
| **Node.js + pnpm** · Node 22 · pnpm 10 | 95 impl. en 76 clases | drizzle, express, fastify, lit, nestjs, prisma, react, solid, svelte, typeorm, vue | [pnpm.io](https://pnpm.io/installation) [@pnpm-installation] |
| **Python** · 3.11 o superior | 91 impl. en 72 clases | django, fastapi, flask, sqlalchemy | [python.org](https://www.python.org/downloads/) [@python-downloads] |
...
Ocho cadenas, **366 implementaciones**. Ninguna es obligatoria: el ejecutor corre las que encuentre y **declara** las que omitió.
