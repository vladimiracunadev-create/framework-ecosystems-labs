...
| --- | ---: | --- | --- |
| **Node.js** · 22 o superior | 10 impl. en 6 clases | alpinejs, htmx, nodejs | [nodejs.org](https://nodejs.org/en/download) [@nodejs-downloads] |
| **Node.js + pnpm** · Node 22 · pnpm 10 | 130 impl. en 84 clases | angular, drizzle, express, fastify, lit, nestjs, prisma, react, solid, svelte, typeorm, vue | [pnpm.io](https://pnpm.io/installation) [@pnpm-installation] |
...
Ocho cadenas, **408 implementaciones**. Ninguna es obligatoria: el ejecutor corre las que encuentre y **declara** las que omitió.
