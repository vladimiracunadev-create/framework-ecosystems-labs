...
>
> Parte **5 — Identidad y seguridad** · Nivel **🟡 intermedio** · Pista **`backend`** (Backend y API)
>
...
Firmar y verificar una credencial sin estado en el servidor.

## 🧩 La situación

Token válido responde 200, alterado responde 401, caducado responde 401.
