# Clase 147 — Elegir framework para un producto

> [⬅️ 146](../146-fin-de-vida-y-soporte/README.md) · [📚 Parte 11](../README.md) · [🎓 Clases](../../README.md) · [148 ➡️](../148-como-se-abandona-un-framework/README.md)
>
...
Decidir con criterio explícito y dejarlo escrito.

## 🧩 La situación

Una decisión registrada con alternativas, criterios y consecuencias.
...
```bash
node scripts/run-class.mjs 147
```
