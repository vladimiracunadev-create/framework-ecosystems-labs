...
> [⬅️ 130](../130-registro-estructurado/README.md) · [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md) · [132 ➡️](../132-trazas/README.md)
>
...
Medir lo que importa: tasa, error y latencia.

## 🧩 La situación

Un punto de métricas expone contadores e histogramas del servicio.
...
```bash
node scripts/run-class.mjs 131
```
