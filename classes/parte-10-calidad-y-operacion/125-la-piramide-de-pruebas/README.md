# Clase 125 — La pirámide de pruebas

> [⬅️ 124](../124-la-primera-prueba/README.md) · [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md) · [126 ➡️](../126-dobles-de-prueba/README.md)
>
...
Repartir el esfuerzo entre niveles según lo que cada uno detecta.

## 🧩 La situación

El mismo comportamiento probado en tres niveles, con su coste y su alcance.
...
```bash
node scripts/run-class.mjs 125
```
