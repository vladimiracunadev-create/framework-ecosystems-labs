...
> [⬅️ 136](../136-arranque-en-frio/README.md) · [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md)
>
...
Encontrar el cuello real en lugar del sospechoso habitual.

## 🧩 La situación

Una mejora guiada por medición, con el antes y el después.
...
```bash
node scripts/run-class.mjs 137
```
