...
> [⬅️ 131](../131-metricas/README.md) · [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md) · [133 ➡️](../133-salud-y-preparacion/README.md)
>
...
Seguir una petición a través de varios procesos.

## 🧩 La situación

Una traza con varios tramos correlacionados entre dos servicios.
...
```bash
node scripts/run-class.mjs 132
```
