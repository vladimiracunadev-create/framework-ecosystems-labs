# Clase 134 — Configuración por entorno

> [⬅️ 133](../133-salud-y-preparacion/README.md) · [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md) · [135 ➡️](../135-empaquetado-y-despliegue/README.md)
>
...
Un artefacto, varios entornos.

## 🧩 La situación

La misma imagen arranca en dos entornos con configuración distinta.
...
```bash
node scripts/run-class.mjs 134
```
