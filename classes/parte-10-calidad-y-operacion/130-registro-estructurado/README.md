# Clase 130 — Registro estructurado

> [⬅️ 129](../129-pruebas-de-contrato/README.md) · [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md) · [131 ➡️](../131-metricas/README.md)
>
...
Emitir registros que una máquina pueda consultar.

## 🧩 La situación

Cada línea es un objeto con campos estables y nivel correcto.
...
```bash
node scripts/run-class.mjs 130
```
