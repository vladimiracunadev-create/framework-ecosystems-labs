# Clase 133 — Salud y preparación

> [⬅️ 132](../132-trazas/README.md) · [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md) · [134 ➡️](../134-configuracion-por-entorno/README.md)
>
...
Distinguir estar vivo de estar listo para recibir tráfico.

## 🧩 La situación

Dos puntos distintos con semántica distinta y verificada.
...
```bash
node scripts/run-class.mjs 133
```
