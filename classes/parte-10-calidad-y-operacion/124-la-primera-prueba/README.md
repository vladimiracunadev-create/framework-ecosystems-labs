# Clase 124 — La primera prueba

> [📚 Parte 10](../README.md) · [🎓 Clases](../../README.md) · [125 ➡️](../125-la-piramide-de-pruebas/README.md)
>
> Parte **10 — Calidad, rendimiento y operación** · Nivel **🟢 introductorio** · Pista **`backend`** (Backend y API)
>
...
Escribir una prueba que falle por la razón correcta.

## 🧩 La situación

Una prueba roja que se vuelve verde con el cambio mínimo.
