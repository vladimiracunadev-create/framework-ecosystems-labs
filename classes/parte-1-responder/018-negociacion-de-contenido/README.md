...
>
> Parte **1 — Responder: lo primero que hace cualquier framework** · Nivel **🟡 intermedio** · Pista **`backend`** (Backend y API)
>
...
Servir la representación que el cliente pide.

## 🧩 La situación

Accept application/json devuelve JSON, text/html devuelve HTML, otro devuelve 406.
